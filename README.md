...
* [Instances](https://github.com/glebtsereteli/Lookout/blob/main/Views/LookoutInstances.gml). Displays the overall and per-object instance counts, including differences between frames, with an option to destroy objects. Helps track existing objects and their instance counts to idenfify misplaced instances.
...
4. Run the game and access your views under the Views menu in the top bar of the [Debug Overlay](https://manual.gamemaker.io/monthly/en/GameMaker_Language/GML_Reference/Debugging/The_Debug_Overlay.htm).
