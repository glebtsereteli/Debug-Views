...
## Views
* **Display**. Provides info and controls for display, window, application surface, and views.
* **Instances**. Displays the overall and per object amounts of instances.
* **Resources**. Displays data fetched from `debug_event("ResourceCounts")` and `debug_event("DumpMemory")`.
* **Rooms**. Provides controls over room switching and displays room history.
